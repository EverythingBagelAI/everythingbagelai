  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="space-y-1">
          <label className="block text-xs font-medium" htmlFor="mobile">
        ...
        <div className="space-y-1">
          <label className="block text-xs font-medium" htmlFor="company">
      ...
      <div className="space-y-2">
        <label className="block text-xs font-medium">
          What are you interested in? <span className="text-[10px] text-muted-foreground">(Select all that apply)</span>
        </label>
        <div className="grid gap-1.5 max-h-48 overflow-y-auto pr-2">
          {services.map((service) => (
            <label
              key={service.id}
              className="flex items-center space-x-2 rounded-lg border bg-white/50 backdrop-blur-sm p-2 cursor-pointer hover:bg-white/80 transition-colors"
            >
              <input
                type="checkbox"
      ...
      <div className="space-y-1">
        <label className="block text-xs font-medium" htmlFor="message">
          Tell us about your project <span className="text-[10px] text-muted-foreground">(Optional)</span>
        </label>
        <Textarea
          id="message"
          ...
          className="h-20 bg-white/50 backdrop-blur-sm resize-none text-sm"
        />
      </div>
